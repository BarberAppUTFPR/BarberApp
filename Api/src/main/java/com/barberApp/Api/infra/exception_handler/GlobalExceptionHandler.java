package com.barberApp.Api.infra.exception_handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ScheduleAlreadyExists.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<Map<String ,String>> scheduleAlreadyExists(ScheduleAlreadyExists e) {
        var body = ErrorMessage(e.getMessage());
        return ResponseEntity.badRequest().body(body);
    }
